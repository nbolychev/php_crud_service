 ...
 */
final class Version20210823182202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE app_product (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(100) NOT NULL, price INT NOT NULL, title VARCHAR(200) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
